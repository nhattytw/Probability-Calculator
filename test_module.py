...
class UnitTests(unittest.TestCase):
    def test_hat_class_contents(self):
        hat = prob_calculator.Hat(black=3,blue=2)
        actual = hat.contents
        expected = ["black","black","black","blue","blue"]
        self.assertEqual(actual, expected, 'Expected creation of hat object to add correct contents.')

    def test_hat_draw(self):
        hat = prob_calculator.Hat(black=5,blue=2)
        actual = hat.draw(2)
        expected = ['blue', 'black']
    ...
    def test_prob_experiment(self):
        hat = prob_calculator.Hat(blue=3,black=2,green=6)
        ...
        hat = prob_calculator.Hat(yellow=5,black=1,green=3,blue=9,test=1)
